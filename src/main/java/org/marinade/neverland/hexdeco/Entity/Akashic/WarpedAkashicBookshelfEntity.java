...
public class WarpedAkashicBookshelfEntity extends HexBlockEntity {
    public static final String TAG_PATTERN = "pattern";
    private HexPattern pattern = null;
    private CompoundTag iotaTag = null;

    public WarpedAkashicBookshelfEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(WARPED_RUNESHELF_TILE.get(), pWorldPosition, pBlockState);
    }
