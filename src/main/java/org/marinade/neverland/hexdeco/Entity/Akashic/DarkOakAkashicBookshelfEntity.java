...
public class DarkOakAkashicBookshelfEntity extends HexBlockEntity {
    ...
    public DarkOakAkashicBookshelfEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(DARK_OAK_RUNESHELF_TILE.get(), pWorldPosition, pBlockState);
    }
