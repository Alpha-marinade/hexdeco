...
public class BambooAkashicBookshelfEntity extends HexBlockEntity {
    ...
    public BambooAkashicBookshelfEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(BAMBOO_RUNESHELF_TILE.get(), pWorldPosition, pBlockState);
    }
