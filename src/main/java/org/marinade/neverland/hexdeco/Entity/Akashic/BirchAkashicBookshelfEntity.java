...
public class BirchAkashicBookshelfEntity extends HexBlockEntity {
    public static final String TAG_PATTERN = "pattern";
    private HexPattern pattern = null;
    private CompoundTag iotaTag = null;

    public BirchAkashicBookshelfEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(BIRCH_RUNESHELF_TILE.get(), pWorldPosition, pBlockState);
    }
