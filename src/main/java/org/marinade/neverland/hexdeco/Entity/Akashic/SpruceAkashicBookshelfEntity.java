...
public class SpruceAkashicBookshelfEntity extends HexBlockEntity {
    public static final String TAG_PATTERN = "pattern";
    private HexPattern pattern = null;
    private CompoundTag iotaTag = null;

    public SpruceAkashicBookshelfEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(SPRUCE_RUNESHELF_TILE.get(), pWorldPosition, pBlockState);
    }
