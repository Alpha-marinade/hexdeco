...
public class JungleAkashicBookshelfEntity extends HexBlockEntity {
    public static final String TAG_PATTERN = "pattern";
    private HexPattern pattern = null;
    private CompoundTag iotaTag = null;

    public JungleAkashicBookshelfEntity(BlockPos pWorldPosition, BlockState pBlockState) {
        super(JUNGLE_RUNESHELF_TILE.get(), pWorldPosition, pBlockState);
    }
