...
public class MangroveAkashicBookshelfRenderer implements BlockEntityRenderer<MangroveAkashicBookshelfEntity> {
        public MangroveAkashicBookshelfRenderer(BlockEntityRendererProvider.Context ctx) {
        }

        @Override
        public void render(MangroveAkashicBookshelfEntity tile, float pPartialTick, PoseStack ps, MultiBufferSource buffer, int light, int overlay) {
