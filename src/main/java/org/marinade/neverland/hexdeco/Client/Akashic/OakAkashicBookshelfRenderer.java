...
public class OakAkashicBookshelfRenderer implements BlockEntityRenderer<OakAkashicBookshelfEntity> {
        public OakAkashicBookshelfRenderer(BlockEntityRendererProvider.Context ctx) {
        }

        @Override
        public void render(OakAkashicBookshelfEntity tile, float pPartialTick, PoseStack ps, MultiBufferSource buffer, int light, int overlay) {
