...
public class JungleAkashicBookshelfRenderer implements BlockEntityRenderer<JungleAkashicBookshelfEntity> {
        public JungleAkashicBookshelfRenderer(BlockEntityRendererProvider.Context ctx) {
        }

        @Override
        public void render(JungleAkashicBookshelfEntity tile, float pPartialTick, PoseStack ps, MultiBufferSource buffer, int light, int overlay) {
