...
public class CherryAkashicBookshelfRenderer implements BlockEntityRenderer<CherryAkashicBookshelfEntity> {
        public CherryAkashicBookshelfRenderer(BlockEntityRendererProvider.Context ctx) {
        }

        @Override
        public void render(CherryAkashicBookshelfEntity tile, float pPartialTick, PoseStack ps, MultiBufferSource buffer, int light, int overlay) {
