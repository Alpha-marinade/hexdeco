...
public class CrimsonAkashicBookshelfRenderer implements BlockEntityRenderer<CrimsonAkashicBookshelfEntity> {
        public CrimsonAkashicBookshelfRenderer(BlockEntityRendererProvider.Context ctx) {
        }

        @Override
        public void render(CrimsonAkashicBookshelfEntity tile, float pPartialTick, PoseStack ps, MultiBufferSource buffer, int light, int overlay) {
