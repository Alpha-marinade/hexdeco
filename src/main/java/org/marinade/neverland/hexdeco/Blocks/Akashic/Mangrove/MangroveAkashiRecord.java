...
public class MangroveAkashiRecord extends BlockAkashicRecord {
    public MangroveAkashiRecord(Properties p_49795_) {
        super(p_49795_);
    }
    public @Nullable BlockPos addNewDatum(BlockPos herePos, Level level, HexPattern key, Iota datum) {
        BlockPos clobbereePos = AkashicFloodfiller.floodFillFor(herePos, level, (pos, bs, world) -> {
            ...
            boolean var10000;
            if (patt975$temp instanceof MangroveAkashicBookshelfEntity tile) {
        ...
        if (clobbereePos != null) {
            ...
            BlockPos openPos = AkashicFloodfiller.floodFillFor(herePos, level, 0.9F, (pos, bs, world) -> {
                ...
                boolean var10000;
                if (patt1329$temp instanceof MangroveAkashicBookshelfEntity tile) {
            ...
            if (openPos != null) {
                MangroveAkashicBookshelfEntity tile = (MangroveAkashicBookshelfEntity)level.getBlockEntity(openPos);
    ...
    public @Nullable Iota lookupPattern(BlockPos herePos, HexPattern key, ServerLevel slevel) {
        BlockPos foundPos = AkashicFloodfiller.floodFillFor(herePos, slevel, (pos, bs, world) -> {
            ...
            boolean var10000;
            if (patt1922$temp instanceof MangroveAkashicBookshelfEntity tile) {
                if (tile.getPattern() != null && tile.getPattern().sigsEqual(key)) {
                    var10000 = true;
                    return var10000;
                }
        ...
        if (foundPos == null) {
            ...
            MangroveAkashicBookshelfEntity tile = (MangroveAkashicBookshelfEntity)slevel.getBlockEntity(foundPos);
