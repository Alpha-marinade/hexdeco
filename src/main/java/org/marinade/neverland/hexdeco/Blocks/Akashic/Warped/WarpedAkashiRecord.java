...
public class WarpedAkashiRecord extends BlockAkashicRecord {
    ...
    public @Nullable BlockPos addNewDatum(BlockPos herePos, Level level, HexPattern key, Iota datum) {
        BlockPos clobbereePos = AkashicFloodfiller.floodFillFor(herePos, level, (pos, bs, world) -> {
            ...
            boolean var10000;
            if (patt975$temp instanceof WarpedAkashicBookshelfEntity tile) {
        ...
        if (clobbereePos != null) {
            ...
            BlockPos openPos = AkashicFloodfiller.floodFillFor(herePos, level, 0.9F, (pos, bs, world) -> {
                ...
                boolean var10000;
                if (patt1329$temp instanceof WarpedAkashicBookshelfEntity tile) {
            ...
            if (openPos != null) {
                WarpedAkashicBookshelfEntity tile = (WarpedAkashicBookshelfEntity)level.getBlockEntity(openPos);
    ...
    public @Nullable Iota lookupPattern(BlockPos herePos, HexPattern key, ServerLevel slevel) {
        BlockPos foundPos = AkashicFloodfiller.floodFillFor(herePos, slevel, (pos, bs, world) -> {
            ...
            boolean var10000;
            if (patt1922$temp instanceof WarpedAkashicBookshelfEntity tile) {
                if (tile.getPattern() != null && tile.getPattern().sigsEqual(key)) {
                    var10000 = true;
                    return var10000;
                }
        ...
        if (foundPos == null) {
            ...
            WarpedAkashicBookshelfEntity tile = (WarpedAkashicBookshelfEntity)slevel.getBlockEntity(foundPos);
